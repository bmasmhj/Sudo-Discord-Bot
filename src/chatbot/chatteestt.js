    ...
    if(message.author.bot) return;
        ...
        (function($) {
            ...
            Bots.push = function(bot) {
                ...
                bot.processActionQueue = function(messages) {
                    var outs = [];
                        ...
                        for (var i = 0; i < actions.length; i++) {
                            ...
                            for (var y = 0; y < c.length; y++) {
                                ...
                                for (var z = 0; z < options.length; z++) {
                                    if (catchMatches(options[z], messages, bot)) {
                                        match = true;
                                        break;
                                    }
                                }
                            ...
                            if (match) {
                                ...
                                if (catchMatches(from, bot.getVariable("USER"), bot)) {
                                    ...
                                    bot.setVariable("INPUT", messages);
            ...
            Bots.sendMessages = function(botname, messages, variables) {
                ...
                messages = bot.precatch.call(bot, messages);
                messages = Bots.processActions(bot, messages);
            ...
            Bots.processActions = function(bot, messages) {
                var actions = bot.actions;
                
                bot.actionQueue.push(bot.actions);
                var r = bot.processActionQueue(messages);
                return r;
                ...
                for (var i = 0; i < actions.length; i++) {
                    ...
                    for (var x = 0; x < c.length; x++) {
                        ...
                        for (var y = 0; y < options.length; y++) {
                            if (catchMatches(options[y], messages, bot)) {
                                match = true;
                                break;
                            }
                        }
            ...
            function replaceVariables(text, messages, bot) {
                ...
                for (var x = 1; x < pieces.length; x += 2) {
                    ...
                    if (piece.charAt(0) === "=") {
                        ...
                        var splitmessages = messages.split(" ");
                        
                        if (wordpos < 0) wordpos = splitmessages.length + wordpos;
                        
                        var word = removePunctuation(splitmessages[wordpos]);
            ...
            function catchMatches(ctext, messages, bot) {
                ctext = removePunctuation(replaceVariables(ctext, messages, bot)).toLowerCase();
                messages = removePunctuation(messages).toLowerCase();
                
                // console.log(messages, ctext, wildCompare(messages, ctext));
                return wildCompare(messages, ctext);
            }
        ...
        Bots.push({
            ...
            "actions": [
                ...
                {
                    "catch": [  "I am bored gossip with me",
                    "Got any gossip",
                    "gossip",
                ...
                "response": [
                    ...
                    "David said he gave I his email address and told I to send him a messagess but when he tried to read his email he could not get to it.",  
        ...
        var r = Bots.sendMessages("Sudo", chat, { "USER": "mrfishie" });
        if(r.length >0 ){
            ...
            messages.reply(`Sorry, I can't understand you`);
        }
